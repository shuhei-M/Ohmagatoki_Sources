Shader "Hidden/Shader/ScreenColor"
{
    Properties
    {
    ...
    float4 CustomPostProcess(Varyings input) : SV_Target
    {
        ...
        // ‚±‚±‚¾‚¯’Ç‰Á‚µ‚Ü‚µ‚½
        color *= lerp(float3(1, 1, 1), float3(1, 0, 0), _IntensityR);
        color *= lerp(float3(1, 1, 1), float3(0, 1, 0), _IntensityG);
        color *= lerp(float3(1, 1, 1), float3(0, 0, 1), _IntensityB);
